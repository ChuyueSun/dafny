...
(define-fun _module.__default.abs ((|x#0| Int) ) Int (U_2_bool 0))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@1| Int) ) (!  (=> (or (|_module.__default.abs#canCall| |x#0@@1|) (not (= 0 $FunctionContextHeight))) (= (_module.__default.abs |x#0@@1|) (ite (< |x#0@@1| 0) (- 0 |x#0@@1|) |x#0@@1|)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@2| Int) ) (!  (=> (or (|_module.__default.abs#canCall| (LitInt |x#0@@2|)) (not (= 0 $FunctionContextHeight))) (= (_module.__default.abs (LitInt |x#0@@2|)) (ite (< |x#0@@2| 0) (- 0 |x#0@@2|) |x#0@@2|)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@3| Int) ) (!  (=> (or (|_module.__default.abs#canCall| |x#0@@3|) (not (= 0 $FunctionContextHeight))) true)
 :qid |assertbpl.2813:16|
 :skolemid |485|
 :pattern ( (_module.__default.abs |x#0@@3|))
))))
...
(assert (forall ((|x#0@@4| T@U) ) (!  (=> (= (type |x#0@@4|) intType) (= ($Is |x#0@@4| Tclass._System.nat) (<= (LitInt 0) (U_2_int |x#0@@4|))))
 :qid |assertbpl.1793:15|
 :skolemid |347|
 :pattern ( ($Is |x#0@@4| Tclass._System.nat))
)))
...
(assert (forall ((|x#0@@5| Int) ) (! (= (|_module.__default.abs#requires| |x#0@@5|) true)
 :qid |assertbpl.2820:15|
 :skolemid |486|
 :pattern ( (|_module.__default.abs#requires| |x#0@@5|))
)))
